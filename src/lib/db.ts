 ...
 *
 * Schema comes from `migrations/*.sql` (0006–0008 ops: waitlist, F4–F6, equipment), auto-applied
 * before the first query — define tables there, never inline in server functions.
 */
